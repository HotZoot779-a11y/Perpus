        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-100 p-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="{{ route('admin.borrowings.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200">
                        Kelola Peminjaman
                    </a>
                </div>
            </div>
