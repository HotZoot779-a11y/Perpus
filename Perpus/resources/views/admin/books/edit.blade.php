                ...
                <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                        ...
                        <div>
                            ...
                            <input type="text" name="year" id="year" value="{{ old('year', $book->year) }}" required min="1800" maxlength="4" pattern="[0-9]{4}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-gray-50 hover:bg-white transition-colors">
                        </div>

                        <!-- Stok -->
                        <div>
                            <label for="stock" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Stok <span class="text-red-500">*</span></label>
                            <input type="text" name="stock" id="stock" value="{{ old('stock', $book->stock) }}" required min="0" maxlength="2" pattern="[0-9]{2}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-gray-50 hover:bg-white transition-colors">
                        </div>
