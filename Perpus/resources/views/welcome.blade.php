...
<body class="bg-gray-50 font-sans leading-normal tracking-normal">
    ...
    <div class="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden mt-16"
        style="background-image: url('https://images.unsplash.com/photo-1512820790803-83ca734da794?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bGlicmFyeSUyMGJvb2tzfGVufDB8fDB8fHww&w=1000&q=80'); background-size: cover; background-position: center;">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="mt-4 max-w-2xl text-xl text-blue-100 mx-auto mb-10">
                Akses koleksi buku perpustakaan SMK Insan Global secara digital. Mudah, cepat, dan nyaman.
            </p>
